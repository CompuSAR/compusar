...
// Git hash  : 95ef6eb1f35fa597a7e8c128a8ae01f978f79171
...
module VexiiRiscv (
  ...
  assign _zz_when_ExecuteLanePlugin_l306_1_3 = (1'b1 && early0_BranchPlugin_logic_flushPort_payload_self);
  assign _zz_when_ExecuteLanePlugin_l306_1_4 = 1'b1;
  assign _zz_when_ExecuteLanePlugin_l306_1_5 = 1'b0;
  assign _zz_when_ExecuteLanePlugin_l306_1_6 = (1'b1 && LsuCachelessPlugin_logic_flushPort_payload_self);
  ...
  always @(*) begin
    ...
    if(execute_ctrl1_down_MMU_PAGE_FAULT_lane0) begin
      LsuCachelessPlugin_logic_onFork_skip = 1'b1;
    end
  ...
  assign switch_Misc_l245 = execute_ctrl1_down_Decode_UOP_lane0[14 : 12];
  always @(*) begin
  ...
  assign _zz_early0_EnvPlugin_logic_exe_xretPriv = execute_ctrl1_down_Decode_UOP_lane0[29 : 28];
  always @(*) begin
  ...
  assign when_LsuCachelessPlugin_l267 = ((execute_ctrl1_down_AguPlugin_LOAD_lane0 && execute_ctrl1_down_LsuCachelessPlugin_logic_onPma_RSP_lane0_io) && 1'b0);
  assign when_LsuCachelessPlugin_l273 = ((execute_ctrl1_down_MMU_ACCESS_FAULT_lane0 || execute_ctrl1_down_LsuCachelessPlugin_logic_onPma_RSP_lane0_fault) || execute_ctrl1_down_LsuCachelessPlugin_logic_pmpPort_ACCESS_FAULT_lane0);
  assign when_LsuCachelessPlugin_l321 = ((execute_ctrl1_up_LANE_SEL_lane0 && execute_ctrl1_down_AguPlugin_SEL_lane0) && LsuCachelessPlugin_logic_onFork_skip);
  ...
  assign when_ExecuteLanePlugin_l306_1 = (|{((early0_EnvPlugin_logic_flushPort_valid && 1'b1) && (1'b0 || (1'b1 && early0_EnvPlugin_logic_flushPort_payload_self))),{((CsrAccessPlugin_logic_flushPort_valid && 1'b1) && (1'b0 || (_zz_when_ExecuteLanePlugin_l306_1 && CsrAccessPlugin_logic_flushPort_payload_self))),{((early0_BranchPlugin_logic_flushPort_valid && _zz_when_ExecuteLanePlugin_l306_1_1) && (_zz_when_ExecuteLanePlugin_l306_1_2 || _zz_when_ExecuteLanePlugin_l306_1_3)),((LsuCachelessPlugin_logic_flushPort_valid && _zz_when_ExecuteLanePlugin_l306_1_4) && (_zz_when_ExecuteLanePlugin_l306_1_5 || _zz_when_ExecuteLanePlugin_l306_1_6))}}});
  ...
  assign execute_freeze_valid = (|{CsrAccessPlugin_logic_fsm_inject_freeze,{(execute_ctrl2_down_LsuCachelessPlugin_WITH_RSP_lane0 && (! LsuCachelessPlugin_logic_onJoin_rspValid)),LsuCachelessPlugin_logic_onFork_freezeIt}});
  ...
  always @(posedge clk or posedge reset) begin
    if(reset) begin
      ...
      `ifndef SYNTHESIS
        `ifdef FORMAL
          assert((! ((((execute_ctrl2_up_LANE_SEL_lane0 && execute_lane0_ctrls_2_upIsCancel) && execute_ctrl2_down_AguPlugin_SEL_lane0) && execute_ctrl2_down_AguPlugin_STORE_lane0) && (! execute_ctrl2_up_TRAP_lane0)))); // LsuCachelessPlugin.scala:L386
        `else
